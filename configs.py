...
class Config(object):
  ...
  BOT_USERNAME = os.environ.get("BOT_USERNAME", "Cartoonworldtelugu_india09_bot")
  ...
  ABOUT_BOT_TEXT = f"""
This is a Permanent FileStore Bot Created by 𝐕𝐚𝐦𝐬𝐢 🐦‍🔥.Others Can use me by joining my updates channel
